...
//let enc = Huffman.encode('TESTTESTTESTTESTTESTTESTTESTTEST123abc');
let enc = Huffman.encode(inputstring);
console.log(enc);
let dec = Huffman.decode(enc);
console.log(dec);

function setup() {
  createCanvas(800,600);
  background(255);
  text('Input: '+inputstring,100,100);
  text('Output: '+enc,100,150);
}
